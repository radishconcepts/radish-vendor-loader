...
class Radish_Vendor_Loader_Admin extends Radish_Vendor_Loader_Core {
	/**
	...
	public function scripts_file_cb( $case, $sub_dir = 'js' ) {
		$file = trailingslashit(dirname(__FILE__)) . 'js';
		$root = 'path' === $case ? plugin_dir_path( $file ) : plugin_dir_url( $file );
